    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          animate={{ scale: 1, y: 0 }}
          exit={{ scale: 0.9, y: 20 }}
          className="relative w-full max-w-2xl bg-black border-2 border-electricRed neon-box-red overflow-hidden"
        >
          {/* Danger Striping Top */}
          ...
          <div className="p-1">
            <div className="relative h-64 w-full overflow-hidden border-b border-electricRed/30">
              <img 
                ...
                className="w-full h-full object-cover opacity-80 mix-blend-screen mix-blend-color-dodge filter sepia hue-rotate-300" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent" />
              
              <div className="absolute bottom-4 left-4 flex items-center gap-2">
                <ShieldAlert className="w-8 h-8 text-electricRed animate-pulse" />
                <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-electricRed glitch" data-text="WARNING: CRITICAL TOPIC">
                  WARNING: CRITICAL TOPIC
                </h2>
              </div>
            </div>

            <div className="p-6 bg-deepBlue/50">
